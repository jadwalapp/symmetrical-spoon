...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \vspace{1.5cm}
        {\Large\bfseries Muwaqqit: An Elegant yet Simple Calendar Manager\par}
        \vspace{2cm}
...
\begin{itemize}
    ...
    \item Accuracy of our algorithms to detect keywords indicating an event agreement has happened, especially for languages other than English and Arabic.
