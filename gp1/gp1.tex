...
\begin{itemize}
    \item The user shall be able to access their account using either Google or Email.
    \item The user should receive a welcome emil if they are a new user.
    ...
    \item The user should be able to receive event notifications.
    \item The user should be able to have a personalized experience by being asked questions.
    \item The user should be able to see events he agreed with people on in WhatsApp in the calendar, and if a conflicst arises, he can fix it through a notification.
\end{itemize}

\section{Non-Functional Requirements}

\begin{itemize}
    \item The app should run on iOS only.
    \item The system should be fast and efficient.
    \item The app should have good user experience, and be easy to use.
\end{itemize}
